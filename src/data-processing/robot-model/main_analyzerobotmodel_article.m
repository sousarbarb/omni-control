...
ylabel('K_{j,p} \rightarrow')
title('Analysis of the parameter K_{j,p} (j=v,v_w,\omega)')
pos(3:4) = [500 500];
set(gcf, 'Position', pos)
saveas(gcf,'robot-model_kp','fig')
saveas(gcf,'robot-model_kp','epsc')
...
ylim([0 0.2])
xlabel('Motion of the robot')
ylabel('\tau_j (s) \rightarrow')
title('Analysis of the parameter \tau_j (j=v,v_w,\omega)')
pos(3:4) = [500 500];
set(gcf, 'Position', pos)
saveas(gcf,'robot-model_tau','fig')
saveas(gcf,'robot-model_tau','epsc')
